...
{
    public class GeneralMovieController : Controller
    {
        private readonly ILogger<GeneralMovieController> _logger;
        private readonly IHttpClientFactory _httpClientFactory;

        public GeneralMovieController(ILogger<GeneralMovieController> logger, IHttpClientFactory httpClientFactory)
        {
            _logger = logger;
            _httpClientFactory = httpClientFactory;
        }

        public async Task<IActionResult> Index(string slug ,string? category, string? country, int? year, string? language, int page = 1)
        {
            ...
            var baseUrl = $"https://phimapi.com/v1/api/danh-sach/{slug}";
            ...
            try
            {
                ...
                {
                    string categoryName = categoryData.data.titlePage ?? "Phim theo thể loại";
